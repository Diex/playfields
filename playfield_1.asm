...
lvblank:		sta 	WSYNC
    			...
    			ldx 	#0 					
drawfield:		lda		#%01010101		; Solid row of pixels for all PF# registers
				sta 	PF0
				lda		#%10101010		; Solid row of pixels for all PF# registers
				sta		PF1
				lda		#%01010101		; Solid row of pixels for all PF# registers
				sta		PF2				
